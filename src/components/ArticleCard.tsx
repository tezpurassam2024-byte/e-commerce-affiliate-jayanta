      ...
      >
        <div className="relative aspect-16/10 bg-slate-100 overflow-hidden">
          ...
          <button
            ...
            className="absolute top-3 right-3 w-8 h-8 rounded-full bg-slate-900/70 hover:bg-slate-900 text-white backdrop-blur-md flex items-center justify-center transition-all hover:scale-110 shadow-sm opacity-90 hover:opacity-100"
          >
